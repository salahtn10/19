        ...
        <div class="success-page__header">
            <div class="success-page__header-wrapper">
                ...
                <h2 class="success-page__title">
                    <span>$name</span>, شكرًا لك على طلبك!
                </h2>
            </div>
        </div>
        <div class="success-page__body">
            <div class="success-page__body-wrapper">
                <h3 class="success-page__text" style="text-align: center">شكرا لك المعلومات المحفوظة.</h3>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="success-page__header-wrapper">
                ...
                <h2 class="success-page__title">
                    ...
                    <p class="success-page__message_success">
                        ...
                        <br>
                        الطرد الخاص بك على وشك الوصول إليك. تأكد من إدخال رقم هاتفك بشكل صحيح وأجب على مكالمة مديرنا لتأكيد التفاصيل.
                    </p>
            </div>
        </div>
        <div class="success-page__body">
                ...
                <div class="form">
                    <form action="" class="success-page__form" name="update_form" id="details" method="post">
                        <div class="success-page__form__container">
                            ...
                            <div class="success-page__form__button" onclick="SubmitForm()"> إرسال </div>
                        </div>
                    </form>
                </div>
            </div>
...
function SubmitForm() {
    ...
    emptyFieldsMsg = "<span style='color: red'>البريد الإلكتروني و/أو العنوان مطلوب!</span>" +
        "<br><br>يرجى التحقق من المعلومات التي قمت بإدخالها",
